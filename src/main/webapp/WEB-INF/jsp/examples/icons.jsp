...
<title>Now UI Dashboard by Sample Application</title>
<meta
...
<body class="">
    ...
    -->
			<div class="logo">
				<a href="./dashboard" class="simple-text logo-mini"> CT </a> <a
					href="./dashboard" class="simple-text logo-normal"> Creative
					Tim </a>
			</div>
		...
		<div class="main-panel" id="main-panel">
			...
			<footer class="footer">
				<div class="container-fluid">
					<nav>
						<ul>
							<li><a href="https://www.creative-tim.com"> Sample Application
							</a></li>
